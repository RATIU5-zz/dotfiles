...
require("nvim-treesitter.configs").setup {
  ensure_installed = {
    ...
    "php", "python", "rust", "sql", "svelte", "tsx", "typescript", "prisma",
    "scss", "make", "pug", "julia", "java", "go", "c", "cpp"
  },
...
require("mason-lspconfig").setup({
  ensure_installed = {
    "astro", "bashls", "cssls", "html", "jsonls",
    "eslint", "marksman", "intelephense", "pyright", "rust_analyzer",
    "sqls", "svelte", "tailwindcss", "sumneko_lua", "tsserver"
  }
})
...
local wk_mappings = {
  ["f"] = {
    ...
    m = { "<cmd>lua vim.lsp.buf.formatting()<cr>", "Format file" }
  },
